...
<jsp:useBean id="related" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Articles>"/>
<jsp:useBean id="comments" scope="request" type="java.util.List<com.messi.king.messinews.model.bean.Comments>"/>
