...
import com.messi.king.messinews.model.bean.EditorManageCategories;
...
public class UsersDAO {
    ...
    public static void extendSubscriber(int id, LocalDateTime expireDate) {
        ...
        Users user = com.messi.king.messinews.model.dao.UsersDAO.findById(id);
    ...
    public static void assignCategories(int editor_id, int[] catesId ) {
        com.messi.king.messinews.model.dao.UsersDAO.deleteEditorCategories(editor_id);
